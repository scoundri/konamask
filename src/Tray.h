...
#define TRAY_ICON1 "audio-input-microphone"
#define TRAY_ICON2 "microphone-sensitivity-high"
#elif TRAY_APPKIT
#define TRAY_ICON1 "tray.ico"
#define TRAY_ICON2 "tray.ico"
#elif TRAY_WINAPI
#define TRAY_ICON1 "tray.ico"
#define TRAY_ICON2 "tray.ico"
#endif
...
static void tray_update(struct tray *tray);
 ...
 // if debugger flags any errors in or coresponding to this file, ignore it
 //  if it is unable to build, check if you've installed them or replace their path inside of makefile
